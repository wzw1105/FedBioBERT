...
def get_args():
    ...
    parser.add_argument("--n_local_rounds", type=int, default=2)
    parser.add_argument(
    ...
    """splitting roberta info."""
    parser.add_argument("--project_path", type=str, default='/public/home/yaodz/wangzw/Roberta')
    parser.add_argument("--data_dir", type=str, default='/public/home/yaodz/wangzw/PubMed/preprocessed_data')
    parser.add_argument("--tot_files", type=int, default=18)

    parser.add_argument("--num_client_encoder", type=int, default=1)
    parser.add_argument("--num_server_encoder", type=int, default=3)
    parser.add_argument("--max_len", type=int, default=512)
    parser.add_argument("--num_device",type=int,default=4)
    parser.add_argument("--fedavg_embedding_head",type=str2bool,default=True) #是否对embedding层做avg
    parser.add_argument("--fedavg_server_model",type=str2bool,default=False) #是否对server-side的model做avg，如果不做就做sequential
    parser.add_argument("--evaluate_step", type=int,default=2) #biobert运行频率
    parser.add_argument("--gpu", type=int, default=0)
    parser.add_argument("--gpu_ids", type=str, default=None)
    parser.add_argument("--checkpoint_save_dir", type=str, default=None)
    parser.add_argument("--num_batch", type=int, default=6500)
    ...
    parser.add_argument("--from_checkpoint_round", type=int, default=None)
    parser.add_argument("--server_model_to_cpu", type=str2bool, default=False)
    # parse conf.

    parser.add_argument("--init_method", type=str, default='tcp://127.0.0.1:23456')
    parser.add_argument("--comm_rank", type=int, default=0)
