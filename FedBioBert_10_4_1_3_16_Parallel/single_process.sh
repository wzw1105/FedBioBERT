...
APP="python3 ../single_process.py \
         ...
         --lr 5e-5 --end_lr 0 --warmup_ratio 0.1\
         --num_client_encoder 1 --num_server_encoder 3 \
         ...
         --checkpoint_save_dir /public/home/yaodz/wangzw/Roberta/FedBioBertModel/FedBioBert_10_4_1_3_16_wholePubmed \
